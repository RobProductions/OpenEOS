...
namespace RobProductions.OpenEOS
{
	public static class EOSCore
	{
		...
		/// Callback function that is run when EOS async Login() is complete.
		...
		/// </returns>
		public static bool Login(PlatformInterface platformSession, EOSLoginSet loginSet, OnLoginCallback loginCompleteDelegate)
		{
			...
			//When it completes, loginCompleteDelegate must determine what to do with the
			...
			authInterface.Login(ref loginOptions, null, loginCompleteDelegate);
			return true;
		}
