...
namespace Epic.OnlineServices
{
	public enum Result : int
	{
		...
		/// <summary>
		/// Request data was <see langword="null" /> or invalid
		/// </summary>
		...
		/// <summary>
		/// Request contained an invalid rich text <see cref="Utf8String" />
		/// </summary>
		PresenceRichTextInvalid = 3006,
		/// <summary>
		/// Request contained a rich text <see cref="Utf8String" /> that was too long
		/// </summary>
