...
namespace Epic.OnlineServices.IntegratedPlatform
{
	public sealed partial class IntegratedPlatformInterface : Handle
	{
		...
		public ulong AddNotifyUserLoginStatusChanged(ref AddNotifyUserLoginStatusChangedOptions options, object clientData, OnUserLoginStatusChangedCallback callbackFunction)
		{
			...
			var optionsInternal = default(AddNotifyUserLoginStatusChangedOptionsInternal);
			...
			var callResult = Bindings.EOS_IntegratedPlatform_AddNotifyUserLoginStatusChanged(InnerHandle, ref optionsInternal, clientDataPointer, OnUserLoginStatusChangedCallbackInternalImplementation.Delegate);
		...
		{
			var optionsInternal = default(ClearUserPreLogoutCallbackOptionsInternal);
			optionsInternal.Set(ref options);
		...
		/// <see cref="IntegratedPlatformOptionsContainer.Release" />
		/// <see cref="Platform.PlatformInterface.Create" />
		/// <see cref="IntegratedPlatformOptionsContainer.Add" />
		/// </summary>
		/// <param name="options">
		/// structure containing operation input parameters.
		/// </param>
		/// <param name="outIntegratedPlatformOptionsContainerHandle">
		/// <see cref="IntPtr" /> to an integrated platform options container handle to be set if successful.
		/// </param>
		/// <returns>
		...
		public static Result CreateIntegratedPlatformOptionsContainer(ref CreateIntegratedPlatformOptionsContainerOptions options, out IntegratedPlatformOptionsContainer outIntegratedPlatformOptionsContainerHandle)
		{
			...
			var outIntegratedPlatformOptionsContainerHandleInnerHandle = IntPtr.Zero;

			var callResult = Bindings.EOS_IntegratedPlatform_CreateIntegratedPlatformOptionsContainer(ref optionsInternal, out outIntegratedPlatformOptionsContainerHandleInnerHandle);

			Helper.Dispose(ref optionsInternal);

			Helper.Get(outIntegratedPlatformOptionsContainerHandleInnerHandle, out outIntegratedPlatformOptionsContainerHandle);
		...
		{
			var optionsInternal = default(FinalizeDeferredUserLogoutOptionsInternal);
			optionsInternal.Set(ref options);

			var callResult = Bindings.EOS_IntegratedPlatform_FinalizeDeferredUserLogout(InnerHandle, ref optionsInternal);
		...
		/// The NotificationId that was returned from registering for Integrated Platform user login and logout notifications.
		/// </param>
		...
		{
			var optionsInternal = default(SetUserLoginStatusOptionsInternal);
			optionsInternal.Set(ref options);

			var callResult = Bindings.EOS_IntegratedPlatform_SetUserLoginStatus(InnerHandle, ref optionsInternal);
		...
		/// </summary>
		/// <param name="options">
		/// Data that specifies the API version.
		/// </param>
		/// <param name="clientData">
		/// An optional context <see cref="IntPtr" /> that is returned in the callback data.
		/// </param>
		/// <param name="callbackFunction">
		...
		public Result SetUserPreLogoutCallback(ref SetUserPreLogoutCallbackOptions options, object clientData, OnUserPreLogoutCallback callbackFunction)
		{
			...
			var optionsInternal = default(SetUserPreLogoutCallbackOptionsInternal);
			optionsInternal.Set(ref options);
			...
			var callResult = Bindings.EOS_IntegratedPlatform_SetUserPreLogoutCallback(InnerHandle, ref optionsInternal, clientDataPointer, OnUserPreLogoutCallbackInternalImplementation.Delegate);
